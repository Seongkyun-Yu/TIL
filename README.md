...
2020-09-02 ~ 09-17 : 프로그래머스 알고리즘 다시 풀이<br>
2020-09-23 : Hash<br>
2020-09-24 : 이진탐색트리<br>
2020-09-25 : 이진탐색트리 삭제 기능<br>
2020-09-26 : Heap<br>
2020-09-27 : Heap 삭제 기능<br>
<br>
...
2020-07-09 : 메가박스 클론 프로젝트 / 로그인 기능 및 가까운 영화관 기능 구현<br>
2020-07-10 : 메가박스 클론 프로젝트 / 마이페이지 api 구현, 영화조건이 달라져 선택 불가시 선택 자동 취소 기능 구현<br>
2020-07-11~12 : 메가박스 클론 프로젝트 / 프록시 버그 수정<br>
2020-07-13 : 메가박스 클론 프로젝트 / 결제 기능 완성<br>
2020-07-14 : 메가박스 클론 프로젝트 / 구글 로그인, 추가 회원정보 api 제작<br>
2020-07-15 : 메가박스 클론 프로젝트 / Amazon S3 & CloudFront를 활용한 배포 연습<br>
2020-07-16 : 메가박스 클론 프로젝트 / 레이아웃 및 버그 수정<br>
2020-07-17 : 메가박스 클론 프로젝트 / 버그 수정, 도메인 연결 및 최종 배포 작업<br>
2020-07-20 : 무한 gps요청 버그 수정<br>
2020-07-21 : 메인페이지 모바일 화면에서 깨지는 버그 수정, 의미 없는 div 제거<br>
2020-07-22 : 상영시간표, BoxOffice 링크 추가<br>
2020-07-23 : 이벤트 페이지 접속시 스크롤 가장 위로 올림<br>
2020-07-24 : ReadMe파일 수정<br>
2020-07-25 : 영화관 정보 페이지 추가 (지도)<br>
2020-07-26 : 영화관 정보 리듀서 추가<br>
2020-07-27 : 영화관 지도 페이지 완성<br>
2020-07-28 : 영화 리스트 이미지에 Lazy Loading 기능 추가<br>
2020-07-29 : 예매, 마이페이지에서 일정 시간 이후 로그인 체크가 안되는 버그 수정<br>
2020-07-30 : 로그인 체크를 한번만 호출하게 수정<br>
2020-07-31 :

- 메인 페이지에서 신규 오픈 극장 선택시 극장 위치 정보 페이지 이동하게 수정
- 마이페이지 새로고침시 내역이 보이지 않는 버그 수정
- 좌석 선택 페이지에서 select 문자열 크로스브라우징 문제 해결

2020-08-03 :

- 영화 코멘트의 영화 제목이 특정 제목으로 고정되고 댓글 수가 특정 숫자로 고정 표기되는 버그 수정
- 새로고침하면 로그아웃 팝업이 뜨는 버그 수정

2020-08-04 :

- 메인페이지 검색기능 제작
- 예매내역 취소시 취소내역 갱신이 자동으로 안되는 버그 수정
- cookie 만료 옵션으로 명시적 기간 설정
- cookie 보안 옵션을 secure로 변경
- React 프로젝트가 HTTPS로 작동되게 변경
...
2020-08-10 : LFS<br>
2020-08-11 ~ 08-20 : SEO Study (스타벅스 클론)<br>
2020-08-22 ~ 08-29 : D3, D3FC 라이브러리 스터디<br>
2020-09-14 ~ 09-17 : 이력서 작성 하는 법 공부 및 이력서 작성<br>
